...
ALARM_PATH := vendor/pixel/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/pixel/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/pixel/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/pixel/prebuilt/common/media/audio/ui
